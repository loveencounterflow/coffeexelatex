...
(function() {
  var BAP, Line_by_line, TRM, TYPES, alert, badge, coffee, debug, echo, eventually, help, info, log, njs_fs, njs_path, rpr, warn, whisper, _echo,
    __slice = [].slice;
  ...
  this.debug = function(message) {
    ...
    return echo("\\textbf{\\textcolor{red}{" + (this.escape(message.replace(/\n+/g, '\\par\\n\\n'))) + "}}");
  };
  ...
  this.helo = function(name) {
    return "{Hello, \\textcolor{blue}{" + (this.escape(name)) + "}!}";
  };
  ...
  this.show_geometry = function() {
    ...
    if ((g = this.aux['geometry']) == null) {
      debug("unable to retrieve geometry info from " + this.aux['auxroute'] + ";");
      return null;
    }
    R = [];
    names = ((function() {
  ...
  this.show_special_chrs = function() {
