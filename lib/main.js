...
(function() {
  ...
  this._main = function() {
     ...
     */
    var command, message, method_name, parameter, parameters, texroute, _ref;
    info("©45 argv: " + (rpr(process.argv)));
    texroute = process.argv[2];
    command = process.argv[3];
    parameter = (_ref = process.argv[4]) != null ? _ref : '';
  ...
  this.show_aux = function() {
    return "\\begin{verbatim}" + (rpr(this.aux)) + "\\end{verbatim}";
  };
