...
(function() {
  ...
  this.decode_url_crumb = function(crumb) {
    ...
    try {
      ...
      error = _error;
      if ((message = error['message']) !== 'URI malformed') {
        throw error;
      }
      warn(message);
      R = message;
  ...
  this.main = function() {
    ...
    process_request = (function(_this) {
      return function(request, response, handler) {
        ...
        texroute = _this.decode_url_crumb(texroute);
        command = _this.decode_url_crumb(command);
        method_name = command.replace(/-/g, '_');

        /* TAINT code duplication */

        /* This should perhaps be done with slashes as well */
        P = (parameters != null) && parameters.length > 0 ? (_this.decode_url_crumb(parameters)).split(',') : [];
